# 🤖 KODECAMP 5X Machine Learning Core
...
├── assignments/                                   # Weekly assignments and implementations
│   ├── FeatureEngineering_Task3_Assignment.ipynb
│   ├── LinearRegressionML.ipynb
│   ├── LinearRegression_GradientDescent.ipynb
│   ├── Logistic_Regression_with_Multiple_Variables.ipynb
│   ├── MultivariableLinearRegression.ipynb
│   └── TASK3_LogisticRegression.ipynb
├── lecture_notes/                                 # Learning materials and lecture notebooks
│   ├── Feature_Engineering.ipynb
│   ├── Lecture_Note_Logistic_Regression.ipynb
│   ├── Random_Forest_with_SkLearn.ipynb
│   └── SVM_With_SkLearn.ipynb
